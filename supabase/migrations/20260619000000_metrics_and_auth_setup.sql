...
-- Allow authenticated users to read data if any metrics are fetched from the database
DROP POLICY IF EXISTS "allow_authenticated_read_all" ON public.authorized_users;
CREATE POLICY "allow_authenticated_read_all" ON public.authorized_users
