    ...
    >
      ...
      <div className="relative z-10 flex-1 flex flex-col lg:flex-row gap-16 items-center justify-center my-8 max-w-7xl mx-auto w-full">
          ...
          <FadeIn delay={600}>
            ...
            <div className="flex flex-col sm:flex-row flex-wrap gap-4">
              <MagneticButton
                ...
                className="bg-white text-black px-8 py-4 font-display font-semibold text-base hover:bg-accent hover:text-white transition-all duration-500 ease-out hover:shadow-[0_0_20px_rgba(45,95,168,0.3)] flex items-center gap-2 group"
              >
                Agendar Diagnóstico&nbsp;
                <ArrowUpRight className="w-4 h-4 group-hover:translate-x-1 group-hover:-translate-y-1 transition-transform duration-500 ease-out" />
              </MagneticButton>
              ...
              <MagneticButton
                ...
                className="px-8 py-4 font-display font-semibold text-base border border-white/15 hover:border-white/30 hover:bg-white/5 transition-all duration-500 ease-out flex items-center justify-center gap-2 group"
              >
        ...
        <div className="w-full lg:w-[420px] flex flex-col gap-4 mt-8 lg:mt-0">
          <FadeIn delay={800}>
            <div className="p-8 border border-white/10 bg-black/40 backdrop-blur-xl hover:bg-black/60 hover:border-accent/50 hover:-translate-y-2 hover:shadow-[0_10px_40px_-10px_rgba(45,95,168,0.2)] transition-all duration-500 ease-out group rounded-xl w-full">
          ...
          <FadeIn delay={900} staggerChildren={100} className="grid grid-cols-2 gap-4">
            {stats.slice(1).map((s, i) => (
              <div
                key={i}
                className="p-6 border border-white/10 bg-black/40 backdrop-blur-xl hover:bg-black/60 hover:border-accent/50 hover:-translate-y-2 hover:shadow-[0_10px_40px_-10px_rgba(45,95,168,0.2)] transition-all duration-500 ease-out group rounded-xl h-full flex flex-col justify-between"
              >
                <div>
